...
function App() {
  ...
  function createData(name, calories, type, carbs, protein, teamNumber, taskNumber) {
  ...
  const rows = [
    ...
    createData('06.10.2019', "00006",  TODO_TYPES.DONE, "Течь трубы в задании - устранить", <CustomButton className="higherBtn" >Высший</CustomButton>, 'Бригада Номер 2', "Задания Номер 2"),
    createData('06.10.2019', "00006",  TODO_TYPES.IN_PROGRESS, "Течь трубы в задании - устранить", <CustomButton className="averageBtn" >Средний</CustomButton>, 'Бригада Номер 2', "Задания Номер 2"),
    createData('06.10.2019', "00006",  TODO_TYPES.NOT_FINISHED, "Течь трубы в задании - устранить", <CustomButton className="lowBtn" >Низкий</CustomButton>, 'Бригада Номер 2', "Задания Номер 2"),
