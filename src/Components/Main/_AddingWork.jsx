...
const _AddingWork = () => {
  ...
  const initialWorkState = [
    "06.10.2019",
    "00006",
    TODO_TYPES.NOT_FINISHED,
    "Течь трубы в задании - устранить",
    <CustomButton className="higherBtn">Высший</CustomButton>,
    "Бригада Номер 2",
    "Задания Номер 2",
  ];
  const handleOnClick = () =>
    dispatchWorkList({ type: ADD_WORK, payload: initialWorkState });

  return (
    <div className="main-addingWork">
      <div className="main-addingWork-content">
        <div>
          <Icon backgroundColor="rgb(49, 139, 254)" color="#fff" size="30px">
        ...
        <div onClick={handleOnClick}>
          <CustomBtn className="addingWorkBtn">
            <AddCircleIcon />
            Новое рабочее задание
          </CustomBtn>
        </div>
      </div>
    </div>
